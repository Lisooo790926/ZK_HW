...
4. HW_4: MerkleProof.js
    - Understand the merkleProof method
      ...
      It is the way to easily proof the exist item in the array and save gas (contract only need to save root)\
      We should prepare blue blocks to proof your leaf is existing
    ...
    - Build the merkleProof keys array and there are two ways\
      ...
      **Second** is directly build it\
      ...
      ```
    - Call merkleProof method to verify the keyword (the same as HW_2)
